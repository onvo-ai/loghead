...
let dbPath = Deno.env.get("LOGGERHEAD_DB_PATH") || "loggerhead.db";
...
if (!isAbsolute(dbPath) && dbPath !== ":memory:") {
    ...
    if (dbPath === "loggerhead.db") {
        dbPath = "/Users/ronnel/Desktop/loggerhead/cli/loggerhead.db";
    }
}

console.error(`[Loggerhead] Using database at: ${dbPath}`);
...
try {
    ...
    const projectRoot = "/Users/ronnel/Desktop/loggerhead/cli";
